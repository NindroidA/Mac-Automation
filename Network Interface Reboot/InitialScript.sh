...
sudo curl -o /temp/AfterBoot.sh https://raw.githubusercontent.com/NindroidA/Mac-Automation/main/Network%20Interface%20Reboot/afterboot.sh
...
sudo chown root:wheel /temp/AfterBoot.sh
